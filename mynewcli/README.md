...
running command...
$ mynewcli (--version)
mynewcli/0.0.0 darwin-arm64 node-v18.11.0
...
_See code: [dist/commands/hello/index.ts](https://github.com/hiromaily/hello-world/blob/v0.0.0/dist/commands/hello/index.ts)_
