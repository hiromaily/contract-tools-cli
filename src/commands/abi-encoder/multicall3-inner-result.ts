...
abi-encoder multicall3-inner-result (./src/commands/abi-encoder/result.ts)
`,
  ];
  ...
  async run(): Promise<void> {
    ...
    this.log(
      'run abi-encoder multicall3-inner-result! (./src/commands/abi-encoder/multicall3-inner-result.ts)',
    );
